...
class PatchMetadata {
  ...
  PatchMetadata(this.timestamp, this.name) {
    if (name.isEmpty) {
  ...
  static PatchMetadata parse(String directoryName) {
    ...
    return PatchMetadata(timestamp, name);
  }

  @override
  bool operator ==(other) => other is PatchMetadata && timestamp == other.timestamp && name == other.name;
